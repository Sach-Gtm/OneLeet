...
const syllabusRoutes = require("./src/routes/content/syllabusRoutes");
const videoRoutes = require("./src/routes/content/videoRoutes");
const reviewRoutes = require("./src/routes/content/reviewRoutes");
const mentorRoutes = require("./src/routes/content/mentorRoutes");
const examPatternRoutes = require("./src/routes/content/examPatternRoutes");
const examsRoutes = require("./src/routes/examsRoutes");
...
const pushRoutes = require("./src/routes/notification/pushRoutes");
...
const scholarshipRoutes = require("./src/routes/content/scholarshipRoutes");
const ambassadorRoutes = require("./src/routes/content/ambassadorRoutes");
