...
const CourseSchema = new mongoose.Schema(
    {
        ...
        // Required for exam batches; counselling-only packs have no LEET exam.
        examCode: { type: String, required: [function () { return this.kind !== "counselling"; }, "examCode is required"], trim: true, index: true },
        ...
        price: { type: Number, default: 0, min: 0 }, // early-bird launch price
        mrp: { type: Number, default: 0, min: 0 }, // struck-through original
        // "exam" = a written-LEET batch tied to examCode; "counselling" = an
        // interview/counselling-only pack for colleges that admit without a LEET.
        kind: { type: String, enum: ["exam", "counselling"], default: "exam", index: true },
        // Days of premium access a purchase grants (display + validity math).
        validityDays: { type: Number, default: 365, min: 1 },
        // Short per-course Success Promise summary (full legal terms live separately).
        successPromise: { type: String, default: "", maxlength: 2000 },
