...
const STATIC = [
    ...
    { path: "/guarantee", title: "The OneLeet Guarantee: Clear Your Target or Get a Refund", desc: "OneLeet's money-back Success Promise: complete the prep and, if you don't secure the promised LEET rank or admission, your course fee is refunded. See exactly what we commit to, per exam." },
    { path: "/ambassador", title: "OneLeet Campus Ambassador Program: Apply (Delhi Diploma Colleges)", desc: "Become a OneLeet Campus Ambassador: earn up to ₹5,000/month, a Letter of Recommendation signed by IIT KGP + IIM Rohtak alumni, a completion certificate, goodies and free premium access. Batch 2026, limited slots. Apply now." },
