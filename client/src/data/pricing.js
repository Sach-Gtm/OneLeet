...
export const EXAM_COURSES = [
    ...
    { slug: "dtu-nsut-leet-2027-foundation", code: "dtu-nsut-leet", name: "DTU / NSUT LEET", subtitle: "Delhi lateral entry", price: 799, mrp: 1799,
      promise: "Top-10 rank → 100% back. Admission on any seat → 60% back." },
    { slug: "bihar-leet-2027", code: "bihar-leet", name: "Bihar LEET", subtitle: "BCECE-LE", price: 699, mrp: 1499,
      promise: "Admission in a top-2 college (MIT Muzaffarpur / BCE Bhagalpur) → 50% back." },
    { slug: "haryana-leet-2027", code: "haryana-leet", name: "Haryana LEET", subtitle: "HSTES", price: 999, mrp: 1899,
      promise: "Admission in YMCA → 50% back. Top-50 rank (not YMCA) → 30% back." },
    { slug: "up-leet-2027", code: "up-leet", name: "CUET / UP LEET", subtitle: "AKTU lateral entry", price: 1499, mrp: 2499,
      promise: "Top-10 rank → 100% back. Admission in a top-3 college → 40% back." },
    { slug: "gujarat-d2d-2027", code: "gujarat-d2d", name: "Gujarat LEET", subtitle: "ACPDC D2D", price: 599, mrp: 1999,
      promise: "Performance-based Success Reward. See the full terms." },
    { slug: "sliet-leet-2027", code: "sliet-leet", name: "SLIET LEET", subtitle: "Longowal", price: 999, mrp: 1899,
      promise: "Performance-based Success Reward. See the full terms." },
];
